...
####Modeling
The response vector for this prediction is a factor with 5 levels in "A", "B", "C", "D" and "E". Based on the response vector, using any classification model will be work. In Searching for a model (see <http://topepo.github.io/caret/modelList.html>) and after some consideration. We will adopt Random Forest and for the reason as below:
